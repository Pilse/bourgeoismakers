...
interface IBrandDelteModalProps {
  onConfirm: () => void;
  onCancel: () => void;
}

export const BrandDeleteModal = ({ onConfirm, onCancel }: IBrandDelteModalProps) => {
  return (
    <div className="absolute top-0 left-0 bg-[#F0F0F0]/85 w-full h-full flex justify-center items-center flex-col">
      <div className="w-[450px] rounded-[16px]  bg-white shadow-[0_4px_6px_-1px_rgb(0,0,0,0.1),0_2px_6px_-1px_rgb(0,0,0,0.06)] p-[32px]">
        <h3 className="text-heading/l">정말 농장을 삭제하시겠어요?</h3>
        <p className="mt-[12px] text-gray-700 text-body/l/400">삭제하신 농장 정보는 복구할 수 없어요.</p>
